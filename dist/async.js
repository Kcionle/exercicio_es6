...
var funcaoMuitoPesaPromise = new Promise(function (resolve, reject) {
  try {
    var execucoes = 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          PromiseComParametros('cassiochan.u@gmail.com', 12345).then(function (resultado) {
            console.log(resultado);
          });
          _context.prev = 2;
          _context.next = 5;
          return funcaoMuitoPesaPromise;
        case 5:
